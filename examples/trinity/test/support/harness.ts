...
/** Verdicts that the default threshold approves and declines. */
export const approve = (scores: Record<string, number> = { safe: 0.97 }): Verdict => ({ reviewer: "jev-test", scores, note: null });
export const decline = (scores: Record<string, number> = { safe: 0.2 }): Verdict => ({ reviewer: "jev-test", scores, note: null });
