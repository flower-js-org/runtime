...
export type Outbound =
  ...
  /** A prompt was answered, anywhere: `card` is the surface's message for it. */
  | { kind: "resolved"; call: string; card: string; prompt: string; resolution: Resolution; by: string | null }
