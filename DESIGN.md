...
| Data access | Native ordered tuple ranges and bounded pages; TS timer/TTL/lease selection; lease history identity | Live pagination, conservative phantom dependencies; scan windows of reading cells stay in RAM |
